...
<html>
	...
	<body>
		<a href="#edit-productOption" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-productOption" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${productOptionInstance?.version}" />
				<fieldset class="form">
