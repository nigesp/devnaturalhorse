...
<li class="add">
<g:link controller="supplyOrder" action="create" params="['supplier.id': supplierInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'supplyOrder.label', default: 'SupplyOrder')])}</g:link>
</li>
</ul>
